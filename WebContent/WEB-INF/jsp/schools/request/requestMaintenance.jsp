<div id="requestMaintenance" class="col s12 m12 l12">
	<div class="row">
		...
		<div class="col s12 m3">
			<div class="col s12">
				<a class="col s12 waves-effect waves-light btn modal-trigger" href="#reqMaintenanceModal"><i class="material-icons left">add</i>Request Maintenance</a>
			</div>
		</div>
	</div>
